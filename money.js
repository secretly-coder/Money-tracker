...
function updateCharts() {
    ...
    // Check if both income and expense are 0
    if (totalIncome === 0 && totalExpense === 0) {
        incomeExpenseChart.innerHTML = `
            <div class="empty-chart-state">
                <img src="empty-state.png" alt="No data" class="empty-chart-image">
                <p class="empty-chart-text-main">No transactions added yet.</p>
                <p class="empty-chart-text-hint">Add your first transaction by clicking the + button below!</p>
            </div>
        `;
    } else {
